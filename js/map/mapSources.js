...
const srcURLs = {
    openData: {
        parks: {
            type: 'geojson',
            url: encodeURI("https://data.cityofnewyork.us/resource/enfh-gkve.geojson?$select=multipolygon,borough,typecategory,name311,location,acres&typecategory='Flagship Park' OR typecategory='Nature Area' OR typecategory='Community Park' OR typecategory='Cemetary' OR typecategory='Neighborhood Park' OR typecategory='Triangle/Plaza' OR typecategory='Historic House Park'")
        },
        thumb: {
            type: 'geojson',
